...
export const authorize = (arg1: string[] = [], arg2: string[] = []) => {
    return (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
        ...
        if (user.roles && user.roles.includes('Superuser')) {
            console.log(`[RBAC DEBUG] User ${user.userId} is Superuser. Access granted.`);
            return next();
        }
        ...
        console.log(`[RBAC DEBUG] User ${user.userId} Access Pool:`, { roles: userRoles, permissions: userPermissions });
